...
class table_common_member extends discuz_table_archive
{
	 ...
	 * @param unknown_type $ziduan
	 * @param unknown_type $were
	 */
	public function getOneInfo($ziduan,$were){	
		$data =DB::result_first('SELECT '.$ziduan.' FROM %t where '.$were, array($this->_table));
		return $data;
	}
}
