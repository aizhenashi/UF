...
//当do不同时，判断是机构认证还是会员认证,都不是，走原来的模版 
if($_GET['do']=='authentication'){
	include template("ucenter/authentication");
}else if($_GET['do']=='orgauthentication'){
	include template("org/orgauthentication");
}else{
